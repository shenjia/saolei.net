...
CREATE TABLE IF NOT EXISTS `user_scores` (
  `id` bigint(20) NOT NULL auto_increment,
  `beg_time` int(10) NOT NULL default '0',
  `beg_3bvs` int(10) NOT NULL default '0',
  `int_time` int(10) NOT NULL default '0',
  `int_3bvs` int(10) NOT NULL default '0',
  `exp_time` int(10) NOT NULL default '0',
  `exp_3bvs` int(10) NOT NULL default '0',
  `sum_time` int(10) NOT NULL default '0',
  `sum_3bvs` int(10) NOT NULL default '0',
